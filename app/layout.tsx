...
export const metadata: Metadata = {
   ...
   * The share card.
   *
   * This page has none, which means every link anybody pastes into Slack,
   * X or a group chat unfurls as a bare grey box with a URL under it — the one
   * surface where the product gets described by somebody else's client rather
   * than by us. The image is generated by app/opengraph-image.tsx so its text
   * can never drift from the tagline above.
   *
   * metadataBase resolves the relative image URL. Absolute is required by every
   * scraper, and left unset Next warns and emits a path no crawler can fetch.
   */
